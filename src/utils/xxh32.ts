...
export const xxh32 = (str: string, seed = 0) => {
  ...
  if (len < 16) {
    for (; ((i + 3) | 0) < len; i = (i + 4) | 0)
      h = Math.imul(
        rotl32(
          (h + Math.imul(dataView.getUint32(i, true), 0xc2b2ae3d)) | 0,
          17,
        ),
        0x27d4eb2f,
      )
    ...
    for (; ((i + 15) | 0) < len; i = (i + 16) | 0) {
      v0 = Math.imul(
        rotl32(
          (v0 + Math.imul(dataView.getUint32((i + 0) | 0, true), 0x85ebca77)) |
            0,
          13,
        ),
        0x9e3779b1,
      ...
      v1 = Math.imul(
        rotl32(
          (v1 + Math.imul(dataView.getUint32((i + 4) | 0, true), 0x85ebca77)) |
            0,
          13,
        ),
        0x9e3779b1,
      ...
      v2 = Math.imul(
        rotl32(
          (v2 + Math.imul(dataView.getUint32((i + 8) | 0, true), 0x85ebca77)) |
            0,
          13,
        ),
        0x9e3779b1,
      ...
      v3 = Math.imul(
        rotl32(
          (v3 + Math.imul(dataView.getUint32((i + 12) | 0, true), 0x85ebca77)) |
            0,
          13,
        ),
        0x9e3779b1,
  ...
  for (; i < len; i = (i + 1) | 0)
    h = Math.imul(
      rotl32((h + Math.imul(dataView.getUint8(i), 0x165667b1)) | 0, 11),
      0x9e3779b1,
    )
